...
export function QuestionsForm({
  ...
  return (
    <div className="bg-white border border-stone-200 rounded-[14px] overflow-hidden">
      {/* Header */}
      <div className="bg-sage-50 border-b border-sage-200 p-5">
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 bg-sage-500 rounded-full flex items-center justify-center shrink-0">
            <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <div>
            <h3 className="font-semibold text-stone-900">A few questions to refine your roadmap</h3>
            <p className="text-sm text-sage-700 mt-1">{data.preliminary_assessment}</p>
          </div>
        </div>
      </div>
